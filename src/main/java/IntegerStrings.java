...
public class IntegerStrings {
    private static final Map<Integer, String> integerStringMap = initializeIntegerStringMap();

    private static final Map<String, Integer> stringIntegerMap = initializeStringIntegerMap();
